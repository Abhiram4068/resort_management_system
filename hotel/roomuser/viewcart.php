...
//header('location:login1.php');
	   ...
	   { 
	   $sql = "select sum(total)as t from cart where status=1 and  userid='$name'";
...
<?php
    ...
    $config=array(
        'srno'=>true,
        'hiddenfields'=>array('room_id','bookingid')
   ...
   $join=array(
	...
	$fields=array('bookingid','room_id','room_no','fees','total');
