...
<?php
    ...
    $actions=array(
        ...
        'delete' => array('label' => 'Check Out', 'link' => 'checkout.php', 'params' => array('id' => 'bookid'), 'attributes' => array('class' => 'btn btn-success'))
    );
    ...
    $condition = "datefrom='" . $date1 . "' AND status=4 AND hid='" . $hid . "'";
