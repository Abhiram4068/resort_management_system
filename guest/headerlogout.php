...
?>
                    ...
                    <div class="col-lg-6">
                        <div class="tn-right">
                            ...
                            <a href="index.php?logout=true" class="bk-btn">Log out</a>
                        ...
                        <div class="nav-menu">
                            <nav class="mainmenu">
                                <ul>
                                    ...
                                    <li ><a href="displaycategory.php">Home</a></li>
									 <li ><a href="datechoice.php">Book Now</a>
                                    <li><a href="viewbooking.php">Cancel</a></li>
                                    <li><a href="view.php">Booking details</a></li>
                                     <li><a href="viewcancel.php">Cancel details</a></li>
